...
ActiveRecord::Schema.define(version: 2022_03_06_073138) do
  ...
  create_table "purchase_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_detail_id"], name: "index_purchase_records_on_product_detail_id"
  ...
  add_foreign_key "product_details", "users"
  add_foreign_key "purchase_records", "product_details"
